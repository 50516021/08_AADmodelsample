...
#SBATCH --job-name=ListenNet_indep_KUL_test_20260714_w01s              # Name of the job
...
#SBATCH --time=3-00:00:00                        # Time limit day-hour:minutes:seconds
...
uv run python main_akira.py --dataset KUL --win_time 0.1
