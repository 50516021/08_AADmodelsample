...
Auditory attention decoder model samples from other research
## Directory Structure
    ./
    ├── SPAt_analysis1_epoching_v*.m        # step1: epoching & .mat generation
    ├── SPAt_analysis1A_trial_selsection.m  # trial selection (optional)
    ...
    ├── SPAt_analysis4_evoked_responce_v*.m # evoked response calculation
    ├── BDF_TriggerCheck.m                  # trigger verification script
...
- Additional artifact processing
- Outputs: step3_*.mat
